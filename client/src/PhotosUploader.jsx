          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute cursor-pointer bottom-1 right-1 text-white bg-black bg-opacity-50 rounded-2xl px-2 py-2"
              >
                <svg
              ...
              <button
                ...
                className="absolute cursor-pointer bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl px-2 py-2"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
